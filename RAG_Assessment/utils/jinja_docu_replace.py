...
def prepare_saq_context(data, course_title, duration="1 hr"):
...
def prepare_pp_context(data, course_title, duration="1 hr"):
...
def generate_assessment_documents(context, assessment_type, output_dir):
    ...
    # Define template folder relative to script location, going up one directory level
...
def create_documents():
    ...
    saq_context = prepare_saq_context(saq_data, course_title=course_title)
    ...
    pp_context = prepare_pp_context(pp_data, course_title=course_title)
