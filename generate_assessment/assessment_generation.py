...
from generate_assessment.utils.agentic_CS import generate_cs
from generate_assessment.utils.agentic_PP import generate_pp
from generate_assessment.utils.agentic_SAQ import generate_saq
...
def parse_slides(slides_path, LLAMA_CLOUD_API_KEY):
    ...
    # Load API keys from Settings UI
